    ...
    def download_action_multi(company, data, where2)
	    begin
		    ...
		    soonje_data = {
			    ...
			    'TP' => ['20230005269','트렌드피커','최민준','010-2027-0258','2262','서울특별시 중랑구 신내역로 165(신내동, 신내 데시앙포레) 221동 902호'],
			    'VM' => ['20230005264','비타민멘토','최민준','010-2027-0258','02055','서울특별시 중랑구 신내역로 165(신내동, 신내우디안아파트) 221동 902호'],
